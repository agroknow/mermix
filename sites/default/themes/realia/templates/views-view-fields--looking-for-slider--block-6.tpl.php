...
$termObj = i18n_taxonomy_localize_terms($termObj);
 ...
 $backgroundUrl = image_style_url('large',$icon_uri);
$fields['value']->content = '<div class="category tall"  style="background: url(\'' .$backgroundUrl. '\') no-repeat center"></div>';
...
<?php endforeach; ?>
<div class="main-link tall"><span class="name"><?php print $termObj->name ?></span></div>
</div>
</div>