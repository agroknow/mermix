...
jQuery("#user-register-form,#user-profile-form").validate({
	...
	if(jQuery(element).attr('name') == 'terms_of_use') {
	jQuery(element).parents('div.form-item-terms-of-use').addClass(errorClass).removeClass(validClass);   
	} else {
	...
	if(jQuery(element).attr('name') == 'terms_of_use') {
	jQuery(element).parents('div.form-item-terms-of-use').removeClass(errorClass).addClass(validClass);   
	} else {
